...
export const translations = {
  tr: {
    ...
    calculator: {
      badge: "ANINDA FİYAT HESAPLAMA",
      title: "Tatil Bütçenizi",
      titleGradient: "Hızlıca Hesaplayın",
      subtitle: "Konaklamak istediğiniz bungalov tipini ve gece sayısını seçerek toplam tutarınızı anında görüntüleyin. (Fiyatlarımız kişi sayısından bağımsız, ev başına gecelik sabittir).",
      step1: "1. BUNGALOV TİPİ SEÇİN",
      step2: "2. KONAKLAMA SÜRESİ (GECE)",
      capacityInfo: "Kapasiteli",
      fixedPriceNotice: "Fiyat kişi sayısından bağımsız, gecelik sabit ücrettir.",
      summaryTitle: "Hesaplanan Özet",
      bungalowStay: "Bungalov Konaklama",
      nightsCount: "Gece",
      cleaningFee: "Temizlik & Servis Bedeli",
      free: "ÜCRETSİZ",
      totalPrice: "TOPLAM TUTARLAR",
      vatIncluded: "KDV Dahil Net Tutar",
      submitCta: "WhatsApp ile Ön Rezerve Talebi Gönder",
    },
    reviews: {
  ...
  en: {
    ...
    calculator: {
      badge: "INSTANT PRICE CALCULATOR",
      title: "Calculate Your Vacation",
      titleGradient: "Budget Instantly",
      subtitle: "Select your preferred bungalow model and number of nights to calculate the total price instantly. (Rates are fixed per bungalow per night, independent of guest count).",
      step1: "1. SELECT BUNGALOW TYPE",
      step2: "2. DURATION OF STAY (NIGHTS)",
      capacityInfo: "Capacity",
      fixedPriceNotice: "Price is fixed per night, independent of guest count.",
      summaryTitle: "Calculated Summary",
      bungalowStay: "Bungalow Stay",
      nightsCount: "Nights",
      cleaningFee: "Cleaning & Service Fee",
      free: "FREE",
      totalPrice: "TOTAL PRICE",
      vatIncluded: "Net Price (VAT Included)",
      submitCta: "Send Pre-Booking Request via WhatsApp",
    },
    reviews: {
  ...
  ar: {
    ...
    bungalows: {
      ...
      perNight: "ليلة",
      nightlyPrice: "السعر لليلة الواحدة",
      guests: "ضيوف",
    ...
    calculator: {
      badge: "حساب السعر الفوري",
      title: "احسب ميزانية عطلتك",
      titleGradient: "بسرعة وسهولة",
      subtitle: "اختر نوع البنغل وعدد الليالي لعرض المبلغ الإجمالي فوراً. (أسعارنا ثابتة للمنزل لليلة الواحدة بغض النظر عن عدد الأشخاص).",
      step1: "1. اختر نوع البنغل",
      step2: "2. مدة الإقامة (بالليالي)",
      capacityInfo: "يتسع لـ",
      fixedPriceNotice: "السعر ثابت لليلة الواحدة بغض النظر عن عدد الأشخاص.",
      summaryTitle: "الملخص المحسوب",
      bungalowStay: "إقامة البنغل",
      nightsCount: "ليالي",
      cleaningFee: "رسوم النظافة والخدمة",
      free: "مجاناً",
      totalPrice: "المبلغ الإجمالي",
      vatIncluded: "المبلغ الصافي (شامل الضريبة)",
      submitCta: "إرسال طلب الحجز المبدئي عبر واتساب",
    },
    reviews: {
