...
export const ReviewCard: React.FC<ReviewCardProps> = ({ review, className = "" }) => {
  return (
    <motion.div
      ...
      transition={SPRING_TRANSITION}
      className={`group relative flex flex-col justify-between p-6 sm:p-7 rounded-3xl bg-white/80 dark:bg-stone-900/50 backdrop-blur-xl border border-amber-900/10 dark:border-white/10 hover:border-amber-500/40 transition-all duration-300 shadow-xl hover:shadow-[0_20px_40px_-15px_rgba(245,158,11,0.2)] ${className}`}
    >
      <div>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <Quote className="w-8 h-8 text-amber-500/20 group-hover:text-amber-400/40 transition-colors" />
        </div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-amber-900/10 dark:border-white/10 mt-auto">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[11px] text-stone-500 dark:text-stone-400">{review.dateText}</span>
          </div>
        </div>
    ...
    <section className="relative bg-[#FDFBF7] dark:bg-stone-950 py-24 px-4 sm:px-6 lg:px-8 overflow-hidden text-stone-900 dark:text-white border-t border-amber-900/5 dark:border-white/5 transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-16 pb-8 border-b border-amber-900/10 dark:border-white/10">
          <div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full backdrop-blur-md bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 text-xs font-semibold uppercase tracking-widest mb-3">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 bg-white/80 dark:bg-stone-900/60 backdrop-blur-xl border border-amber-900/10 dark:border-white/10 p-4 sm:p-5 rounded-3xl shadow-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-2xl font-black text-stone-900 dark:text-white">4.9</span>
