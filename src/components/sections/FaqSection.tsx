    ...
    >
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <div className="px-5 sm:px-6 pb-6 text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-normal border-t border-amber-900/5 dark:border-white/5 pt-4">
              {faq.answer}
            </div>
          </motion.div>
        )}
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight">
            Aklınıza Takılan <br className="hidden sm:inline" />
          ...
          <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg mt-4 font-normal leading-relaxed">
            Giriş-çıkış saatlerinden evcil hayvan kurallarına, ısıtmalı havuz detaylarından rezervasyon iptal politikalarına kadar tüm merak edilenler.
          </p>
        </div>
