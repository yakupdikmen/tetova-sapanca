...
export const LiveWeatherBanner: React.FC<LiveWeatherBannerProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`w-full max-w-4xl mx-auto bg-slate-900/80 dark:bg-slate-900/90 border border-emerald-500/30 backdrop-blur-xl rounded-2xl p-4 sm:p-5 shadow-2xl text-white ${className}`}
    >
