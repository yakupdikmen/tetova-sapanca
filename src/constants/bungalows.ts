...
export const BUNGALOW_CATEGORIES: BungalowCategory[] = [
  ...
  },
  {
    ...
    description: "Doğa İçi Verandalı",
...
export const MOCK_BUNGALOWS: Bungalow[] = [
  {
    id: "platin-villa",
    title: "Platin Villa",
    tagline: "Tetova Sapanca'nın En Lüks Isıtmalı Havuzlu VIP Malikane Villası",
    subtitle: "Özel Isıtmalı Sonsuzluk Havuzlu & Ateş Çukurlu Platin Villa",
    categoryId: "platin",
    capacity: 6,
    sqm: 150,
    bedrooms: 3,
    ...
    amenities: ["🔥 4 Mevsim Isıtmalı Havuz", "🔥 Özel Ateş Çukuru", "🌿 %100 Korumalı Özel Bahçe"],
    features: ["🔥 4 Mevsim Isıtmalı Havuz", "🔥 Özel Ateş Çukuru", "🌿 %100 Korumalı Özel Bahçe"],
    featured: true,
    isFeatured: true,
  },
  {
    ...
    subtitle: "Özel Isıtmalı Havuzlu Gold Bungalov",
    categoryId: "gold",
    capacity: 4,
    sqm: 110,
    bedrooms: 2,
    ...
    location: "Kırkpınar Soğuksu, Sapanca",
    amenities: ["🔥 Isıtmalı Havuz", "🍖 Özel Barbekü", "🌿 Geniş Çim Bahçe", "📶 Fiber Wi-Fi"],
    features: ["🔥 Isıtmalı Havuz", "🍖 Özel Barbekü", "🌿 Geniş Çim Bahçe", "📶 Fiber Wi-Fi"],
    featured: false,
    isFeatured: false,
  },
  {
    ...
    tagline: "Doğa İçi Verandalı Silver Konsept Bungalov",
    subtitle: "Doğa İle Baş Başa Silver Bungalov",
    categoryId: "silver",
    capacity: 3,
    sqm: 85,
    bedrooms: 1,
    ...
    location: "Kırkpınar Soğuksu, Sapanca",
    amenities: ["🔥 Ateş Çukuru", "🌲 Orman Manzarası", "☕ Veranda & Dinlenme Alanı"],
    features: ["🔥 Ateş Çukuru", "🌲 Orman Manzarası", "☕ Veranda & Dinlenme Alanı"],
    featured: false,
    isFeatured: false,
  },
  {
